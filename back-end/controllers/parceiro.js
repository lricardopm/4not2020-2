...
controller.listar = async (req, res) => {
    try {
        let dados = await Parceiro.find() // Traz todos os Parceiros cadastrados
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Parceiro.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Parceiro.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Parceiro.findByIdAndDelete(id)
